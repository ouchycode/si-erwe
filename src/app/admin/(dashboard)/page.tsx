...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div>
        <h1 className="text-2xl font-extrabold text-gray-900 mb-2">Dashboard RW 12</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {stats.map((stat, i) => (
          <div key={i} className="bg-white border border-gray-200 shadow-sm rounded-xs p-6 flex items-start gap-4">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white border border-gray-200 shadow-sm rounded-xs p-6">
          <h3 className="text-sm font-bold text-gray-900 mb-4 border-b border-gray-100 pb-3">Laporan Terbaru</h3>
          <div className="space-y-4">
            {[1,2,3].map(i => (
              <div key={i} className="flex items-start gap-3">
                ...
                <div>
                  <p className="text-sm font-bold text-gray-900 mb-0.5">Lampu PJU Mati (TKT-00{i})</p>
        ...
        <div className="bg-white border border-gray-200 shadow-sm rounded-xs p-6 border-l-4 border-l-brand-primary">
