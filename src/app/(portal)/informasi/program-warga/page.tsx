      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 -mt-16 relative z-10 flex flex-col gap-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          {PROGRAMS.map(({ icon: Icon, title, subtitle, image, desc, detail }) => (
            <article
              key={title}
              className="bg-white border border-slate-100 rounded-xs shadow-sm overflow-hidden flex flex-col"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <section className="lg:col-span-2 bg-white border border-slate-100 rounded-xs shadow-sm p-6 md:p-8">
            ...
            <div className="divide-y divide-slate-100 border border-slate-100 rounded-xs overflow-hidden">
              {JADWAL.map((item) => (
                <div key={item.label} className="grid grid-cols-1 md:grid-cols-3 gap-3 bg-slate-50/60 px-5 py-4">
          ...
          <aside className="bg-brand-primary border border-brand-primary-hover rounded-xs shadow-sm p-6 text-white">
        ...
        <div className="bg-white border border-slate-100 rounded-xs shadow-sm p-6 flex flex-col md:flex-row md:items-center justify-between gap-5">
