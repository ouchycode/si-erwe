    ...
    <nav className="sticky top-0 z-50 font-sans flex flex-col w-full">
      ...
      <div className="bg-white px-4 md:px-8 py-3 md:py-3.5">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 md:gap-4 no-underline"
          >
                ...
                <div className="absolute left-0 top-full w-64 bg-white opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-opacity duration-150 z-50 flex flex-col border-t-4 border-brand-primary shadow-lg rounded-b-sm">
                  {item.children.map((child) => (
                    ...
                    >
                      <child.icon
                        size={16}
                        className="mt-0.5 shrink-0 text-gray-400 transition-colors group-hover:text-brand-primary"
                      />
                    ...
                    {item.children.map((child) => (
                      ...
                      >
                        ...
                        <span className="flex flex-col gap-0.5">
                          ...
                          <span className="text-[11px] font-normal leading-snug text-white/60">
                            {child.description}
                          </span>
                        </span>
                      </Link>
