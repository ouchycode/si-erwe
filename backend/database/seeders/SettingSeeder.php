...
class SettingSeeder extends Seeder
{
    public function run(): void
    {
        $settings = [
            ...
            ['group' => 'identitas', 'key' => 'nama', 'value' => 'DARMA BAKTI RW 004'],
            ['group' => 'identitas', 'key' => 'tagline', 'value' => 'Kota Tangerang'],
            ['group' => 'keamanan_wilayah', 'key' => 'deskripsi', 'value' => 'Perangkat pengamanan wilayah RW 004 Pabuaran, Kota Tangerang'],
            ['group' => 'keamanan_wilayah', 'key' => 's1Judul', 'value' => 'Petugas Keamanan'],
            ['group' => 'keamanan_wilayah', 'key' => 's1Teks', 'value' => [
                'Sistem keamanan lingkungan RW 004 dikelola oleh tim keamanan yang terlatih dan berdedikasi tinggi. Mereka bertugas secara bergilir 24 jam untuk memastikan kenyamanan dan ketertiban seluruh warga.',
            ...
            ['group' => 'keamanan_wilayah', 'key' => 's2Teks', 'value' => [
                'Sebagai komitmen dalam meningkatkan keamanan, wilayah RW 004 kini telah dilengkapi dengan puluhan titik kamera pengawas (CCTV) yang menjangkau area strategis seperti gerbang masuk utama, persimpangan blok, dan fasilitas umum.',
            ]],
            ...
            ['group' => 'kebersihan_lingkungan', 'key' => 'deskripsi', 'value' => 'Layanan kebersihan dan pengelolaan lingkungan RW 004 Pabuaran, Kota Tangerang'],
            ...
            ['group' => 'posyandu', 'key' => 'deskripsi', 'value' => 'Pos Pelayanan Terpadu kesehatan ibu, anak, dan lanjut usia RW 004 Pabuaran, Kota Tangerang'],
            ['group' => 'posyandu', 'key' => 's1Judul', 'value' => 'Kader Posyandu & Pelayanan'],
            ['group' => 'posyandu', 'key' => 's1Teks', 'value' => [
                'Layanan Posyandu RW 004 Pabuaran digerakkan oleh para kader kesehatan yang terlatih dan berdedikasi. Mereka bertugas memberikan pelayanan kesehatan dasar bagi ibu hamil, bayi, balita, serta warga lanjut usia (lansia) di lingkungan sekitar.',
            ...
            ['group' => 'posyandu', 'key' => 's2Teks', 'value' => [
                'Gedung Posyandu RW 004 Pabuaran dilengkapi dengan fasilitas yang memadai untuk menunjang kegiatan pelayanan kesehatan secara optimal. Bekerja sama dengan tenaga kesehatan dari Puskesmas setempat, kami menyediakan layanan imunisasi dasar lengkap, pemeriksaan ibu hamil, hingga pemeriksaan kesehatan preventif seperti tekanan darah dan gula darah bagi lansia.',
            ...
            ['group' => 'profil', 'key' => 'visi', 'value' => 'Terwujudnya lingkungan RW 004 yang Aman, Bersih, Guyub, dan Sejahtera berlandaskan nilai-nilai Ketuhanan dan Gotong Royong.'],
            ...
            ['group' => 'layanan', 'key' => 'alur', 'value' => [
                ...
                ['step' => '03', 'title' => 'Validasi RW', 'desc' => 'Bawa surat yang sudah ditandatangani RT ke Sekretariat RW 004 untuk validasi stempel.'],
            ...
            ['group' => 'program_warga', 'key' => 'daftar', 'value' => [
                [
                    ...
                    'gambar' => 'https://images.unsplash.com/photo-1464226184884-fa280b87c399?q=80&w=1200&auto=format&fit=crop',
                ...
                [
                    ...
                    'gambar' => 'https://images.unsplash.com/photo-1532996122724-e3c354a0b15b?q=80&w=1200&auto=format&fit=crop',
